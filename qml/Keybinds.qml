...
QtObject {
    readonly property var entries: [
        ...
        { key: "f", label: qsTr("feed"), pages: ["history", "watchnext"] },
    ...
    // quit, feed), only that letter is highlighted; otherwise the key is shown
    // highlighted ahead of the action (j/k, right-click).
